...
$('#low-vision').click(function(){
  ...
  if(clickCount%2 === 0) {
    $('body').css('background','url("images/brickwall.png")');
    $('h4').hover(function(){
      $(this).css('background-color','lightblue');
    });
  } else {
...
$('#social-links img').hover(function(){
  $(this).toggleClass('socialBackground');
});
...
$('.reference-contact1,.reference-contact2').hide();


$('.btn1').click(function(){
  $(this).hide();
  $('.reference-contact1').show();
});

$('.btn2').click(function(){
  $(this).hide();
  $('.reference-contact2').show();
});
